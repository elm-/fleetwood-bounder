...
import fleetwood.bounder.json.JacksonJsonWriter;
...
public class MemoryProcessEngine extends ProcessEngineImpl {
  ...
  public void saveProcessInstance(ProcessInstance processInstance) {
    ...
    log.debug("Saving: "+JacksonJsonWriter.toJsonStringPretty(processInstance));
  }
  ...
  public void flush(ProcessInstance processInstance) {
    ...
    if (updates!=null) {
      ...
      for (Update update : updates) {
        log.debug("  " + JacksonJsonWriter.toJsonString(update));
      }
    } else {
  ...
  public void flushAndUnlock(ProcessInstance processInstance) {
    ...
    log.debug("Process instance should be: "+JacksonJsonWriter.toJsonStringPretty(processInstance));
  }
  ...
  public ProcessInstance lockProcessInstanceByActivityInstanceId(ActivityInstanceId activityInstanceId) {
    ...
    log.debug("Locked process instance: "+JacksonJsonWriter.toJsonStringPretty(processInstance));
