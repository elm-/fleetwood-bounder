...
public class MongoWorkflowInstanceStore extends MongoCollection implements WorkflowInstanceStore {
  ...
  @Override
  public List<WorkflowInstanceImpl> findWorkflowInstances(WorkflowInstanceQueryImpl workflowInstanceQuery) {
  ...
  protected ActivityInstanceImpl readActivityInstance(WorkflowInstanceImpl processInstance, BasicDBObject dbActivityInstance) {
    ...
    if (workflow!=null) {
      ...
      activityInstance.activityDefinition = workflow.findActivity(activityInstance.activityDefinitionId);
