...
public class ProcessEngineConfiguration {
  ...
  public ProcessEngineConfiguration(ServiceRegistry serviceRegistry) {
  ...
  public ProcessEngineConfiguration registerService(Object service) {
    serviceRegistry.registerService(service);
    return this;
  }
  
  public ProcessEngineConfiguration registerJavaBeanType(Class<?> javaBeanType) {
  ...
  public ProcessEngineConfiguration registerDataType(DataType dataType) {
    getDescriptors().registerDataType(dataType);
    return this;
  }

  public ProcessEngineConfiguration registerJobType(Class<? extends JobType> jobTypeClass) {
