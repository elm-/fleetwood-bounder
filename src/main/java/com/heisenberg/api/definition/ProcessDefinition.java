...
public class ProcessDefinition extends ScopeDefinition {
  ...
  @Override
  public ProcessDefinition id(Object id) {
    super.id(id);
    return this;
  }
  ...
  @Override
  public ProcessDefinition transition(Object fromActivityDefinitionId, Object toActivityDefinitionId) {
    super.transition(fromActivityDefinitionId, toActivityDefinitionId);
    return this;
  }

  @Override
  public ProcessDefinition transition(TransitionDefinition transition) {
