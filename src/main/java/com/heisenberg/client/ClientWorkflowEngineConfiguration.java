 ...
 * @author Walter White
 */
public class ClientWorkflowEngineConfiguration extends WorkflowEngineConfiguration {

  public String baseUrl;

  public WorkflowEngine buildProcessEngine() {
    return new ClientWorkflowEngine(this);
  }

  public ClientWorkflowEngineConfiguration baseUrl(String baseUrl) {
